...
<!-- Condition pour les tris  -->
	...
	<tr style="border-bottom: 1px solid #ddd"> 
		<td vertical-align="middle">{!! Form::checkbox('c'.$c, $societev->id, null, ['class' => 'listcheckbox checkbox']) !!}</td>
	  	...
	  	<td class="statut-type">
	  		
	  			@if($societev->statut=='0')
	  		    	<p class=" statut-contact"><span class="label label-primary">Prospect</span></p> 
	  		    @elseif($societev->statut == '2')
	  		    	<p class=" statut-contact"><span class="label label-default">Prospect</span></p> 
	  		    @endif
